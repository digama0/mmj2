...
public class Oper extends SearchArgsComboBox {

    public Oper(final int i) {
        super(SearchOptionsConstants.OPER_FIELD_ID[i]);
    }
    ...
    {
        csa.searchOperChoice[SearchOptionsConstants.FIELD_ATTR[fieldId].rowIndex] = getAndErrorIfBadChoice(
            searchOutput, SearchOptionsConstants.OPER_VALUES);
    }
}