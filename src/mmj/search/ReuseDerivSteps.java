...
// Source File Name:   ReuseDerivSteps.java
...
//            SearchArgsCheckBox, CompiledSearchArgs, SearchMgr, SearchOutput

public class ReuseDerivSteps extends SearchArgsCheckBox {

    public ReuseDerivSteps() {
        super(41);
    }
    ...
    {
        csa.searchReuseDerivSteps = getBool();
    }
}