...
// Source File Name:   MaxExtResults.java
...
public class MaxExtResults extends SearchArgsInt {

    public MaxExtResults() {
        super(32);
    }
    ...
    {
        csa.searchMaxExtResults = getAndErrorIfNegative(searchOutput);
    }
}