...
/*
 * PrevStepsChecked.java  0.01 20/09/2012
 *
 * Version 0.01:
...
public class PrevStepsChecked extends SearchArgsInt {

    public PrevStepsChecked() {
        super(38);
    }
    ...
    {
        csa.searchPrevStepsChecked = getAndErrorIfNegative(searchOutput);
    }
}
