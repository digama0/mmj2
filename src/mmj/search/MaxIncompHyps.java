...
// Source File Name:   MaxIncompHyps.java
...
public class MaxIncompHyps extends SearchArgsInt {

    public MaxIncompHyps() {
        super(35);
    }
    ...
    {
        csa.searchMaxIncompHyps = getAndErrorIfNegative(searchOutput);
    }
}