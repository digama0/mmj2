...
public class LogicalSystem implements SystemLoader {
     ...
     *
     * @param gmffManager used for Graphics Mode Formula
     *        Formatting in Proof Assistant but loaded with
     *        $t typesetting info by Systemizer.
     *
    ...
    /**
     *  Cache Metamath comment containing typesetting definitions
     *  for use by GMFF.
     *  <p>
     *  Note: comment is from mmj.mmio.SrcStmt so it does not contain
     *        the "$(" and "$)" start/end comment id tokens which
     *        are standard to Metamath comments.
     *  <p>
