...
/**
 * Optional "Frame" of a Theorem (OptFrame not present in other Assrt's).
 * <p>
...
public class OptFrame {
    ...
    /**
     * FIRST DRAFT :) --> "optHypArray" includes all of the variable hypotheses
     * in scope of a theorem that are not present in "hypArray" (above).
     */
    public Hyp[] optHypArray;

    /**
     * FIRST DRAFT :) --> "optDjVarsArray" includes all of DjVars (pairs) in
     * scope which are not present in djVarsArray (above).
     */
