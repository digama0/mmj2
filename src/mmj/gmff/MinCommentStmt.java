...
/**
 *  General object representing a Comment statement
 *  on a <code>MinProofWorksheet</code>.
 *  <p>
 *  Proof Worksheet Comment statements consist of just
 *  an "*" in column one of the first line of the
 *  statement followed by text characters -- which must
 *  be valid Metamath characters but are not otherwise
 *  validated.
 *  <p>
 *  GMFF typesets nothing on the Comment statement,
 *  everything is output as just "escaped" text.
 */
public class MinCommentStmt extends MinProofWorkStmt {
    ...
    /**
     *  Formats export data for the Comment statement
     *  according to the <code>Model A</code> specifications
     *  and loads the data into a specified buffer.
     *  <p>
     *  Model A model files for <code>MinCommentStmt</code> objects
     ...
     *  Worksheet export.
     *  <p>
     *  Note the quirky handling of <code>modelAGenComment1X</code>.
     *  If this model file is empty then no data is output
