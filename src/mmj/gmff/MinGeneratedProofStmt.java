...
/**
 *  General object representing a Generated Proof statement
 *  on a <code>MinProofWorksheet</code>.
 *  <p>
 *  Generated Proof statements are generated by mmj2 Proof
 *  Assistant when the user presses Ctrl-U (Unify) and
 *  unification successfully creates a Metamath proof --
 *  which is simply a RPN (Reverse Polish Notation) list
 *  of Metamath statement labels. The Generated Proof
 *  statement consists of "$=" in column 1 of the first
 *  line of the Generated Proof statement followed by
 *  the space-separated list of statement labels.
 *  <p>
 *  Nothing is typeset by GMFF, and the labels are output
 *  as if they were just text, or comments (unlike the
 *  Metamath Proof Explorere web pages which contain
 *  hyperlinks for the statement labels.)
 */
public class MinGeneratedProofStmt extends MinProofWorkStmt {
     ...
     *  <p>
     *  Model A model files for <code>MinGeneratedProofStmt</code> objects
     ...
     *  Worksheet export.
     *  <p>
     *  Note the quirky handling of <code>modelAGenProof1X</code>.
