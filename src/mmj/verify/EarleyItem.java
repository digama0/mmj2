 ...
 *  algorithm representing partial or complete satisfaction of
 *  a grammar rule by a subsequence of an expression being parsed.
 */
public class EarleyItem {

    /**
     *   NotationRule reference used to avoid copying expr
    ...
    /**
     *  Index to next Cnst (Sym) in expr, equal to the
     *  Earley loop counter, "i".
     *  <p>
     ...
     *  of physically moving the dot around in the EarleyItem.
     *  <p>
     *  A value of 1 means that the dot is *before* the first
