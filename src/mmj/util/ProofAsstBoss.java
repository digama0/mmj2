...
public class ProofAsstBoss extends Boss {
        ...
        IOException, VerifyException
    {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_LOOK_AND_FEEL.matches(runParm)) {
            editProofAsstLookAndFeel(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_DJ_VARS_SOFT_ERRORS
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_PROOF_FORMAT.matches(runParm)) {
            editProofAsstProofFormat(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_INCOMPLETE_STEP_CURSOR
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_HIGHLIGHTING_ENABLED
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_HIGHLIGHTING_STYLE
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_FOREGROUND_COLOR_RGB
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_BACKGROUND_COLOR_RGB
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_FONT_SIZE.matches(runParm)) {
            editProofAsstFontSize(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_FONT_FAMILY.matches(runParm)) {
            editProofAsstFontFamily(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_FONT_BOLD.matches(runParm)) {
            editProofAsstFontBold(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_LINE_SPACING.matches(runParm)) {
            editProofAsstLineSpacing(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_TEXT_COLUMNS.matches(runParm)) {
            editProofAsstTextColumns(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_TEXT_ROWS.matches(runParm)) {
            editProofAsstTextRows(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_ERROR_MESSAGE_ROWS
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_ERROR_MESSAGE_COLUMNS
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_MAXIMIZED.matches(runParm)) {
            editProofAsstMaximized(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_TEXT_AT_TOP.matches(runParm)) {
...
//      }
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_FORMULA_LEFT_COL
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_FORMULA_RIGHT_COL
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_RPN_PROOF_LEFT_COL
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_RPN_PROOF_RIGHT_COL
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_MAX_UNIFY_ALTERNATES
            .matches(runParm))
            // DEPRECATED
            return true;

        if (UtilConstants.RUNPARM_PROOF_ASST_MAX_UNIFY_HINTS.matches(runParm))
            // DEPRECATED
            return true;

        if (UtilConstants.RUNPARM_PROOF_ASST_UNIFY_HINTS_IN_BATCH
            .matches(runParm))
            // DEPRECATED
            return true;

        if (UtilConstants.RUNPARM_STEP_SELECTOR_MAX_RESULTS.matches(runParm)) {
            editStepSelectorMaxResults(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_STEP_SELECTOR_SHOW_SUBSTITUTIONS
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_STEP_SELECTOR_DIALOG_PANE_WIDTH
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_STEP_SELECTOR_DIALOG_PANE_HEIGHT
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_ASSRT_LIST_FREESPACE
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_OUTPUT_CURSOR_INSTRUMENTATION
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_AUTO_REFORMAT.matches(runParm)) {
            editProofAsstAutoReformat(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_UNDO_REDO_ENABLED
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_DUMMY_VAR_PREFIX.matches(runParm))
            // deprecated.
            return true;

        if (UtilConstants.RUNPARM_PROOF_ASST_DEFAULT_FILE_NAME_SUFFIX
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_PROOF_FOLDER.matches(runParm)) {
            editProofAsstProofFolder(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_RECHECK_PROOF_ASST_USING_PROOF_VERIFIER
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_UNIFY_SEARCH_EXCLUDE
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_EXPORT_TO_FILE.matches(runParm)) {
            doProofAsstExportToFile(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.matches(runParm)) {
            doProofAsstBatchTest(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PROOF_ASST_OPTIMIZE_THEOREM_SEARCH
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_AUTOCOMPLETE_ENABLED
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_USE_AUTOTRANSFORMATIONS
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_DERIVE_AUTOCOMPLETE
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_STEP_SELECTOR_BATCH_TEST.matches(runParm)) {
            doStepSelectorBatchTest(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_PREPROCESS_REQUEST_BATCH_TEST
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_PROOF_ASST_STARTUP_PROOF_WORKSHEET
            .matches(runParm))
        {
        ...
        if (UtilConstants.RUNPARM_SET_MM_DEFINITIONS_CHECK.matches(runParm)) {
            // DEPRECATED
            doSetMMDefinitionsCheck(runParm);
            return true;
        }

        if (UtilConstants.RUNPARM_RUN_PROOF_ASST_GUI.matches(runParm)) {
        ...
        throws IllegalArgumentException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_LOOK_AND_FEEL.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final boolean highlightingEnabled = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_HIGHLIGHTING_ENABLED.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final Color color = editRunParmValueReqRGBColor(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_FOREGROUND_COLOR_RGB.name());
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final Color color = editRunParmValueReqRGBColor(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_BACKGROUND_COLOR_RGB.name());
        ...
        throws IllegalArgumentException
    {
        ...
        final int fontSize = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_FONT_SIZE.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_FONT_FAMILY.name(), 1);
//      try {
//          String familyName =
...
//      }
        ...
        throws IllegalArgumentException
    {
        ...
        final boolean boldFont = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_FONT_BOLD.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final int textColumns = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_TEXT_COLUMNS.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final int textRows = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_TEXT_ROWS.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int textRows = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_ERROR_MESSAGE_ROWS.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int textColumns = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_ERROR_MESSAGE_COLUMNS.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final boolean enabled = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_MAXIMIZED.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final boolean enabled = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_TEXT_AT_TOP.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final int formulaRightCol = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_FORMULA_RIGHT_COL.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int rpnProofRightCol = editRunParmValueReqPosInt(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_RPN_PROOF_RIGHT_COL.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_STEP_SELECTOR_SHOW_SUBSTITUTIONS.name(),
            valueFieldNbr);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int stepSelectorDialogPaneWidth = editRunParmValueReqPosInt(
            runParm,
            UtilConstants.RUNPARM_STEP_SELECTOR_DIALOG_PANE_WIDTH.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int stepSelectorDialogPaneHeight = editRunParmValueReqPosInt(
            runParm,
            UtilConstants.RUNPARM_STEP_SELECTOR_DIALOG_PANE_HEIGHT.name(), 1);
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final int proofAsstAssrtListFreespace = editRunParmValueReqNonNegativeInt(
            runParm,
            UtilConstants.RUNPARM_PROOF_ASST_ASSRT_LIST_FREESPACE.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final File proofFolder = editExistingFolderRunParm(
            ...
            UtilConstants.RUNPARM_PROOF_ASST_PROOF_FOLDER.name(), 1); // field
                                                                      // nbr of
        // folder
        ...
        final RunParmArrayEntry runParm) throws IllegalArgumentException
    {
        ...
        final File startupProofWorksheetFile = editExistingFileRunParm(
            batchFramework.paths.getMMJ2Path(), runParm,
            UtilConstants.RUNPARM_PROOF_ASST_STARTUP_PROOF_WORKSHEET.name(), 1); // field
        // nbr
        // of
        // folder
        ...
        throws IllegalArgumentException
    {
        ...
        final boolean autoReformat = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_AUTO_REFORMAT.name(), 1);
        ...
        throws IllegalArgumentException
    {
        ...
        final boolean enabled = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_UNDO_REDO_ENABLED.name(), 1);
        ...
        throws IllegalArgumentException, IOException, VerifyException
    {
        ...
        final Writer exportWriter = editProofAsstExportFileRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_EXPORT_TO_FILE.name());
        ...
        selectorAll = getSelectorAllRunParmOption(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_EXPORT_TO_FILE.name(), 1);
        if (selectorAll == null) {
        ...
        if (editProofAsstPrintParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_EXPORT_TO_FILE.name(), 6))
        ...
        throws IllegalArgumentException, IOException, VerifyException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 1);

        final boolean exportFormatUnified = editProofAsstExportFormatUnifiedParm(
            runParm, UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 3);
        ...
        final HypsOrder exportHypsOrder = editProofAsstExportHypsOrderParm(
            runParm, UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 4);
        getProofAsstPreferences().setExportHypsOrder(exportHypsOrder);

        OutputBoss outputBoss = null;
        if (editProofAsstPrintParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 5))
            outputBoss = batchFramework.outputBoss;

        final boolean exportDeriveFormulas = editProofAsstExportDeriveFormulasParm(
            runParm, UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 6);
        ...
        final boolean importCompareDJs = editProofAsstImportCompareDJsParm(
            runParm, UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 7);
        ...
        final Reader importReader = editProofAsstImportFileRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_BATCH_TEST.name(), 2);
        ...
        final RunParmArrayEntry runParm) throws VerifyException
    {
        ...
        final boolean supportPrefix = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_USE_AUTOTRANSFORMATIONS.name(), 3);

        if (enabled)
            proofAsst.initAutotransformations(debug, supportPrefix);
    }
        ...
        throws VerifyException
    {
        final boolean autocomplete = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_AUTOCOMPLETE_ENABLED.name(), 1);
    ...
    {
        final boolean autocomplete = editYesNoRunParm(runParm,
            UtilConstants.RUNPARM_PROOF_ASST_DERIVE_AUTOCOMPLETE.name(), 1);
        ...
        throws IllegalArgumentException, IOException, VerifyException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_STEP_SELECTOR_BATCH_TEST.name(), 3);

        // 1st option
        final Reader importReader = editProofAsstImportFileRunParm(runParm,
            UtilConstants.RUNPARM_STEP_SELECTOR_BATCH_TEST.name(), 1);

        // 2nd option
        final int cursorPos = editRunParmValueInteger(runParm.values[1].trim(),
            UtilConstants.RUNPARM_STEP_SELECTOR_BATCH_TEST.name()).intValue();
        ...
        throws IllegalArgumentException, IOException, VerifyException
    {
        ...
        editRunParmValuesLength(runParm,
            UtilConstants.RUNPARM_PREPROCESS_REQUEST_BATCH_TEST.name(), 2);

        // 1st option
        final Reader r = editProofAsstImportFileRunParm(runParm,
            UtilConstants.RUNPARM_PREPROCESS_REQUEST_BATCH_TEST.name(), 1);
        ...
        final PreprocessRequest preprocessRequest = editPreprocessRequestOption(
            ...
            UtilConstants.RUNPARM_PREPROCESS_REQUEST_BATCH_TEST.name());
        ...
        final String valueCaption) throws IllegalArgumentException
    {
        if (s.equalsIgnoreCase(
            UtilConstants.RUNPARM_OPTION_ERASE_AND_REDERIVE_FORMULAS))
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (exportFormatUnifiedParm.equalsIgnoreCase(
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (exportHypsRandomizedParm.equalsIgnoreCase(
        ...
        if (exportHypsRandomizedParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_PROOF_ASST_CORRECT))
            return HypsOrder.CorrectOrder;

        if (exportHypsRandomizedParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_PROOF_ASST_REVERSE))
            return HypsOrder.ReverseOrder;

        if (exportHypsRandomizedParm.equalsIgnoreCase(
            UtilConstants.RUNPARM_OPTION_PROOF_ASST_HALF_REVERSE))
            return HypsOrder.HalfReverseOrder;

        if (exportHypsRandomizedParm.equalsIgnoreCase(
            UtilConstants.RUNPARM_OPTION_PROOF_ASST_AUTOCOMPLETE))
            return HypsOrder.Autocomplete;

        if (exportHypsRandomizedParm.equalsIgnoreCase(
            UtilConstants.RUNPARM_OPTION_PROOF_ASST_SOME_ORDER))
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (exportDeriveFormulasParm.equalsIgnoreCase(
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (importCompareDJsParm.equalsIgnoreCase(
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (importUpdateDJsParm.equalsIgnoreCase(
        ...
        final int valueFieldNbr) throws IllegalArgumentException
    {
        ...
        if (asciiRetestParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_ASCII_RETEST))
            return true;

        if (asciiRetestParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_NO_ASCII_RETEST))
            return false;
            ...
            throws IllegalArgumentException
    {
        ...
        if (printParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_PROOF_ASST_PRINT))
            return true;

        if (printParm
            .equalsIgnoreCase(UtilConstants.RUNPARM_OPTION_PROOF_ASST_NO_PRINT))
            return false;
