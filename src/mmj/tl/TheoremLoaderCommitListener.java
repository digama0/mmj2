 ...
 *  <p>
 *  This is used by the LogicalSystem to keep track of
 *  which objects need to be told that the TheoremLoader
 *  has just stored a MMTTheoremSet in the LogicalSystem.
 */
public interface TheoremLoaderCommitListener {
     ...
     *
     * @param mmtTheoremSet Set of TheoremStmtGroup updates now
     *                      committed
     */
