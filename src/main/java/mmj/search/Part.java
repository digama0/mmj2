...
public class Part extends SearchArgsComboBox {
    ...
    public Part(final int i) {
        super(SearchOptionsConstants.PART_FIELD_ID[i]);
    }
    ...
    {
        csa.searchPartChoice[SearchOptionsConstants.FIELD_ATTR[fieldId].rowIndex] = getAndErrorIfBadChoice(
            searchOutput, SearchOptionsConstants.PART_VALUES);
    }
}
